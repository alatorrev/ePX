 ...
 * @author BOTTAGO
 */
public class FarmaciaLazyLoads extends LazyDataModel<CabeceraMovimiento> {
    private List<CabeceraMovimiento> lista;
    private Usuario sessionUsuario;

    public FarmaciaLazyLoads(Usuario sessionUsuario) {
    ...
    public List<CabeceraMovimiento> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        ...
        this.setRowCount(new TransaccionDAO().totalRecordsFarmacia(sessionUsuario,sb));
        lista = new TransaccionDAO().loadWorkingAreaFarmacia(sessionUsuario, first, pageSize,sb);
        return lista;
    }
